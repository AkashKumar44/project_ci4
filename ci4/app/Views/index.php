...
<head>
<meta charset="utf-8">
<title>Desix | Digital agency HTML Template | Home Page 01</title>
<!-- Stylesheets -->
...
<!--[if lt IE 9]><script src="<?= base_url('/assets') ?>/js/respond.js"></script><![endif]-->
</head>
...
<div class="page-wrapper">
	...
	<header class="main-header header-style-one">
		...
		<div class="header-lower">
			...
			<div class="main-box">
				<div class="logo-box">
					<div class="logo"><a href="index.html"><img src="<?= base_url('/assets') ?>/images/logo.png" alt="" title="Tronis"></a></div>
				</div>
		...
		<div class="mobile-menu">
			...
			<nav class="menu-box">
				<div class="upper-box">
					<div class="nav-logo"><a href="index.html"><img src="<?= base_url('/assets') ?>/images/logo.png" alt="" title=""></a></div>
		...
		<div class="sticky-header">
			<div class="auto-container">
				<div class="inner-container">
					<!--Logo-->
					<div class="logo">
						<a href="index.html" title=""><img src="<?= base_url('/assets') ?>/images/logo-2.png" alt="" title=""></a>
					</div>
			...
			<div class="rev_slider fullwidthabanner" id="rev_slider_one" data-version="5.4.1">
				<ul>
					...
					<li data-index="rs-1" data-transition="zoomout">
						<!-- MAIN IMAGE -->
						<img src="<?= base_url('/assets') ?>/images/main-slider/1.jpg" alt="" class="rev-slidebg">
		...
		<div class="auto-container">
			...
			<div class="row">
				...
				<div class="service-block col-lg-3 col-md-6 coll-md-12 wow fadeInUp">
					<div class="inner-box">
						<div class="image-box">
							<figure class="image"><img src="<?= base_url('/assets') ?>/images/resource/service-1.jpg" alt=""></figure>
						</div>
				...
				<div class="service-block col-lg-3 col-md-6 coll-md-12 wow fadeInUp">
					<div class="inner-box">
						<div class="image-box">
							<figure class="image"><img src="<?= base_url('/assets') ?>/images/resource/service-2.jpg" alt=""></figure>
						</div>
						<div class="content-box">
				...
				<div class="service-block col-lg-3 col-md-6 coll-md-12 wow fadeInUp">
					<div class="inner-box">
						<div class="image-box">
							<figure class="image"><img src="<?= base_url('/assets') ?>/images/resource/service-3.jpg" alt=""></figure>
						</div>
						<div class="content-box">
				...
				<div class="service-block col-lg-3 col-md-6 coll-md-12 wow fadeInUp">
					<div class="inner-box">
						<div class="image-box">
							<figure class="image"><img src="<?= base_url('/assets') ?>/images/resource/service-4.jpg" alt=""></figure>
						</div>
						<div class="content-box">
			...
			<div class="row">
					...
					<div class="inner-column">
						...
						<div class="other-info">
							<div class="author-info">
								<div class="inner">
									<figure class="thumb"><img src="<?= base_url('/assets') ?>/images/resource/avatar.jpg" alt=""></figure>
				...
				<div class="image-column col-lg-6 col-md-12 col-sm-12 wow fadeInLeft">
					<div class="image-box">
						...
						<figure class="image-1 wow fadeIn"><img src="<?= base_url('/assets') ?>/images/resource/about-1.jpg" alt=""></figure>
						<figure class="image-2 wow fadeIn" data-wow-delay="600ms"><img src="<?= base_url('/assets') ?>/images/resource/about-2.jpg" alt=""></figure>
						<div class="exp-box">
							<div class="inner">
	...
	<section class="call-to-action">
		...
		<div class="auto-container">
			<div class="outer-box wow fadeIn">
				<figure class="small-image"><img src="<?= base_url('/assets') ?>/images/resource/img.jpg" alt=""></figure>
					...
					<div class="inner-column">
						<div class="row">
							<div class="col-lg-6 col-md-6">
								<div class="image-box">
									<figure class="image overlay-anim"><img src="<?= base_url('/assets') ?>/images/resource/faq.jpg" alt=""></figure>
									<div class="exp-box">
							...
							<div class="testimonial-block">
								<div class="inner-box">
									...
									<div class="info-box">
										...
										<figure class="thumb"><img src="<?= base_url('/assets') ?>/images/resource/testi-thumb-1.jpg" alt=""></figure>
		...
		<div class="auto-container">
			<div class="row">
				...
				<div class="image-column col-lg-6 col-md-12 col-sm-12">
					<div class="inner-column">
						<div class="image-box">
							<figure class="image anim-overlay"><img src="<?= base_url('/assets') ?>/images/resource/why-us.jpg" alt=""></figure>
							<div class="rounded-text">
								<img src="<?= base_url('/assets') ?>/images/resource/round-text.png" alt="">
			...
			<div class="outer-box">
				<div class="row">
					...
					<div class=" project-block col-lg-3 col-md-6 col-sm-12 wow fadeInUp">
						<div class="inner-box">
							<div class="image-box">
								<figure class="image"><a href="page-project-details.html"><img src="<?= base_url('/assets') ?>/images/resource/project-1.jpg" alt=""></a></figure>
							</div>
							<div class="content-box">
					...
					<div class=" project-block col-lg-3 col-md-6 col-sm-12 wow fadeInUp" data-wow-delay="300ms">
						<div class="inner-box">
							<div class="image-box">
								<figure class="image"><a href="page-project-details.html"><img src="<?= base_url('/assets') ?>/images/resource/project-2.jpg" alt=""></a></figure>
							</div>
							<div class="content-box">
								<a href="page-project-details.html" class="icon"><i class="fa fa-long-arrow-alt-right"></i></a>
								<span class="cat">Development</span>
					...
					<div class=" project-block col-lg-3 col-md-6 col-sm-12 wow fadeInUp" data-wow-delay="600ms">
						<div class="inner-box">
							<div class="image-box">
								<figure class="image"><a href="page-project-details.html"><img src="<?= base_url('/assets') ?>/images/resource/project-3.jpg" alt=""></a></figure>
							</div>
							<div class="content-box">
								<a href="page-project-details.html" class="icon"><i class="fa fa-long-arrow-alt-right"></i></a>
								<span class="cat">Development</span>
					...
					<div class=" project-block col-lg-3 col-md-6 col-sm-12 wow fadeInUp" data-wow-delay="900ms">
						<div class="inner-box">
							<div class="image-box">
								<figure class="image"><a href="page-project-details.html"><img src="<?= base_url('/assets') ?>/images/resource/project-4.jpg" alt=""></a></figure>
							</div>
							<div class="content-box">
								<a href="page-project-details.html" class="icon"><i class="fa fa-long-arrow-alt-right"></i></a>
								<span class="cat">Development</span>
		...
		<div class="auto-container">
			...
			<div class="row">
				...
				<div class="news-block col-lg-4 col-md-6 col-sm-12 wow fadeInUp">
					<div class="inner-box">
						<div class="image-box">
							<figure class="image"><a href="news-details.html"><img src="<?= base_url('/assets') ?>/images/resource/news-1.jpg" alt=""></a></figure>
						</div>
						<div class="content-box">
				...
				<div class="news-block col-lg-4 col-md-6 col-sm-12 wow fadeInUp" data-wow-delay="300ms">
					<div class="inner-box">
						<div class="image-box">
							<figure class="image"><a href="news-details.html"><img src="<?= base_url('/assets') ?>/images/resource/news-2.jpg" alt=""></a></figure>
						</div>
						<div class="content-box">
							<span class="date">20 April</span>
							<ul class="post-info">
				...
				<div class="news-block col-lg-4 col-md-6 col-sm-12 wow fadeInUp">
					<div class="inner-box">
						<div class="image-box">
							<figure class="image"><a href="news-details.html"><img src="<?= base_url('/assets') ?>/images/resource/news-3.jpg" alt=""></a></figure>
						</div>
						<div class="content-box">
							<span class="date">20 April</span>
							<ul class="post-info">
	...
	<section class="contact-section">
		...
		<div class="auto-container">
			<div class="outer-box">
				...
				<!--End Contact Form -->
				<figure class="image"><img src="<?= base_url('/assets') ?>/images/resource/girl.png" alt=""></figure>
			</div>
		</div>
	</section>
	<!-- End Contact Section -->
		...
		<div class="auto-container">
			...
			<div class="sponsors-outer">
				...
				<ul class="clients-carousel owl-carousel owl-theme">
					<li class="client-block"> <a href="#"><img src="<?= base_url('/assets') ?>/images/clients/1.png" alt=""></a> </li>
					<li class="client-block"> <a href="#"><img src="<?= base_url('/assets') ?>/images/clients/1.png" alt=""></a> </li>
					<li class="client-block"> <a href="#"><img src="<?= base_url('/assets') ?>/images/clients/1.png" alt=""></a> </li>
					<li class="client-block"> <a href="#"><img src="<?= base_url('/assets') ?>/images/clients/1.png" alt=""></a> </li>
					<li class="client-block"> <a href="#"><img src="<?= base_url('/assets') ?>/images/clients/1.png" alt=""></a> </li>
					...
					<div class="footer-column col-xl-5 col-lg-4 col-md-12">
						<div class="footer-widget about-widget">
							<div class="widget-content">
								<div class="logo"><a href="#"> <img src="<?= base_url('/assets') ?>/images/logo.png" alt=""></a></div>
